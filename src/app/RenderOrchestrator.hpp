...
struct TestSceneParams {
    ...
    glm::vec3 bgColor1{0.0745f, 0.0745f, 0.1804f};
    glm::vec3 bgColor2{0.7804f, 0.9686f, 1.0f};
    float eta = 0.0f;
    float refractScale = 1.078f;
    float refractBoost = 8.0f;
    float rimStrength = 0.0f;
    float emissiveBase = 1.0f;
    float diffuseMix = 0.0f;
    float reflectStrength = 1.539f;
    float fadeAlpha = 0.946f;
    bool animateTint = false;
    float tintLerp = 0.0f;
    float colorPeriod = 20.0f;
    glm::vec3 tint1{0.0f, 1.0f, 0.8235f};
    glm::vec3 tint2{0.251f, 1.0f, 1.0f};
    int composition = 0;
